...
Public Class crystalAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BISU_BILAR_SSG_ATTENDANCE_MONITORING.crystalAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrystalAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crystalAttendance = New crystalAttendance()
        rpt.Site = Me.Site
        Return rpt
    End Function
